 ...
 */
public class ChoseFoodListAdapter extends ArrayAdapter<IFood> implements ListAdapter {

    private Context context;
    private ArrayList<IFood> foods;

    public ChoseFoodListAdapter(Context context, ArrayList<IFood> foods) {
...
//        Button button = (Button) row.findViewById(R.id.rowPurchaseFood_button_purchase);
