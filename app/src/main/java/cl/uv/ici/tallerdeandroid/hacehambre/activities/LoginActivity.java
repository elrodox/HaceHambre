...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     * the user.
     */
    public class UserLoginTask extends AsyncTask<Void, Void, IUser> {
...
//            String userTypeFromBackend = "client";
        ...
        @Override
        protected void onPostExecute(final IUser user) {
            mAuthTask = null;
            showProgress(false);

            if (user!=null) {
                Intent homeIntent = new Intent(LoginActivity.this, user.getHomeActivityClass());
                Bundle bundleObject = new Bundle();
                bundleObject.putSerializable("user", user);
                homeIntent.putExtras(bundleObject);
